...
-- | Query stake pool delegations and reward balances for registered
-- credentials.
--
-- The two result fields have different coverage: 'qrdarDelegations'
-- contains only credentials that are actually delegated to a stake
-- pool, while 'qrdarRewards' contains all selected registered
-- credentials regardless of delegation status.
--
