    ...
    case coe v5 of
      MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v6
        -> coe
             ...
             (coe MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_26 (coe v6))
    ...
    case coe v3 of
      ...
      MAlonzo.Code.Relation.Binary.Definitions.C_tri'8776'_158 v5
        -> coe
             MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__34
             (coe MAlonzo.Code.Agda.Builtin.Bool.C_true_10)
             (coe MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_26 (coe v5))
    ...
    case coe v3 of
      MAlonzo.Code.Relation.Binary.Definitions.C_tri'60'_150 v4
        -> coe
             MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__34
             (coe MAlonzo.Code.Agda.Builtin.Bool.C_true_10)
             (coe MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_26 (coe v4))
      MAlonzo.Code.Relation.Binary.Definitions.C_tri'8776'_158 v5
        -> coe
             MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__34
             (coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8)
...
d_map'45'NonEmpty_832 ::
  ...
  (AgdaAny -> AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Relation.Binary.Definitions.T_NonEmpty_406 ->
  MAlonzo.Code.Relation.Binary.Definitions.T_NonEmpty_406
...
du_map'45'NonEmpty_832 v0 v1
  = coe
      MAlonzo.Code.Relation.Binary.Definitions.C_nonEmpty_426
      (coe MAlonzo.Code.Relation.Binary.Definitions.d_x_420 (coe v1))
      (coe MAlonzo.Code.Relation.Binary.Definitions.d_y_422 (coe v1))
      (coe
         v0 (MAlonzo.Code.Relation.Binary.Definitions.d_x_420 (coe v1))
         (MAlonzo.Code.Relation.Binary.Definitions.d_y_422 (coe v1))
         (MAlonzo.Code.Relation.Binary.Definitions.d_proof_424 (coe v1)))
