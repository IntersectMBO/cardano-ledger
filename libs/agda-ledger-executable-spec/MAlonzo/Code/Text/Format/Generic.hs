...
newtype T_FormatSpec_6
  = C_FormatSpec'46'constructor_25 (MAlonzo.Code.Agda.Builtin.Char.T_Char_6 ->
                                    Maybe AgdaAny)
...
d_lexArg_18 v0
  = case coe v0 of
      C_FormatSpec'46'constructor_25 v3 -> coe v3
...
d_unionSpec_24 v0 v1
  = coe
      C_FormatSpec'46'constructor_25
      (\ v2 ->
         coe
...
d_toRevString_132 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Char.T_Char_6] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_toRevString_132 ~v0 ~v1 = du_toRevString_132
du_toRevString_132 ::
  [MAlonzo.Code.Agda.Builtin.Char.T_Char_6] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_toRevString_132
  = coe
      ...
      (coe MAlonzo.Code.Data.List.Base.du_reverse_490)
...
d_push_134 ~v0 ~v1 v2 v3 = du_push_134 v2 v3
du_push_134 ::
  [MAlonzo.Code.Agda.Builtin.Char.T_Char_6] ->
  [T_Chunk_60] -> [T_Chunk_60]
du_push_134 v0 v1
  = let v2
          = coe
              ...
              (coe C_Raw_64 (coe du_toRevString_132 v0)) (coe v1) in
    case coe v0 of
      [] -> coe v1
      _ -> coe v2
             ...
             '%'
               -> let v8
                        = coe
                            ...
                            erased erased (coe du_push_134 (coe v2))
                            (d_type_144
                               (coe v0) (coe v1)
                               (coe
                                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22 (coe '%') (coe v3))
                               (coe v6)) in
                  case coe v6 of
                    (:) v9 v10
                      -> case coe v9 of
      ...
      (:) v4 v5
        -> coe
             ...
             (coe
                ...
                (coe du_chunk_182 (coe v0) (coe v2) (coe v5) (coe v4)))
             (d_loop_142
                (coe v0) (coe v1)
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
                (coe
...
d_chunk_182 ::
  ...
  MAlonzo.Code.Agda.Builtin.Char.T_Char_6 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_chunk_182 v0 ~v1 v2 ~v3 v4 v5 = du_chunk_182 v0 v2 v4 v5
du_chunk_182 ::
  T_FormatSpec_6 ->
  [MAlonzo.Code.Agda.Builtin.Char.T_Char_6] ->
  [MAlonzo.Code.Agda.Builtin.Char.T_Char_6] ->
    ...
    case coe v4 of
      ...
      MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
        -> coe
             ...
             MAlonzo.Code.Level.d_0ℓ_22 (coe du_toRevString_132 v1)
             (\ v5 ->
                coe
                  MAlonzo.Code.Function.Strict.du_force'8242'_56 ()
