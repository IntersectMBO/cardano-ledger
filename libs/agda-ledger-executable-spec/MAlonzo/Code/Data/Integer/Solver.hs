...
d__'42'H__8
  = let v0 = MAlonzo.Code.Level.d_0ℓ_22 in
    ...
    let v2
          = coe
              MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_fromCommutativeRing_1120
              (coe
                 MAlonzo.Code.Data.Integer.Properties.d_'43''45''42''45'commutativeRing_5438) in
    let v3 = MAlonzo.Code.Data.Integer.Properties.d__'8799'__2476 in
    coe
