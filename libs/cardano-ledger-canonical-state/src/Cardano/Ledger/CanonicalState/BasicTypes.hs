...
import Cardano.Ledger.Hashes (Hash, KeyHash (..), ScriptHash (..))
...
newtype CanonicalVRFVerKeyHash (kr :: H.KeyRoleVRF) = CanonicalVRFVerKeyHash {unCanonicalVRFVerKeyHash :: Hash H.HASH H.KeyRoleVRF}
  deriving (Eq, Ord, Show, Generic)
