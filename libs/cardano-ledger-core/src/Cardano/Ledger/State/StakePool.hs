...
instance EncCBORGroup StakePoolParams where
  encCBORGroup stakePoolParams =
    encCBOR (sppId stakePoolParams)
      <> encCBOR (sppVrf stakePoolParams)
      <> encCBOR (sppPledge stakePoolParams)
      <> encCBOR (sppCost stakePoolParams)
      <> encCBOR (sppMargin stakePoolParams)
      <> encCBOR (sppRewardAccount stakePoolParams)
      <> encCBOR (sppOwners stakePoolParams)
      <> encCBOR (sppRelays stakePoolParams)
      <> encodeNullMaybe encCBOR (strictMaybeToMaybe (sppMetadata stakePoolParams))
  listLen _ = 9
  listLenBound _ = 9
  ...
  decCBORGroup = do
    ...
    pure $
      StakePoolParams
        ...
        , sppOwners = owners
        , sppRelays = relays
        , sppMetadata = maybeToStrictMaybe md
        }
