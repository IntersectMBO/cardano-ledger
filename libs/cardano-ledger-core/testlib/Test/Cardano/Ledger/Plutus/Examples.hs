...
odddata3 =
  Plutus
    ...
    . pack
    . ( \case
          SPlutusV1 -> [88, 26, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 13, 32, 4, 17, 32, 1, 22, 1]
          SPlutusV2 -> [88, 26, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 13, 32, 4, 17, 32, 1, 22, 1]
          SPlutusV3 -> [88, 25, 1, 1, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 13, 32, 4, 24, 0, 11, 1]
      )
...
oddRedeemer3 =
  Plutus
    ...
    . pack
    . ( \case
          SPlutusV1 -> [88, 26, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 9, 32, 4, 17, 32, 1, 22, 1]
          SPlutusV2 -> [88, 26, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 9, 32, 4, 17, 32, 1, 22, 1]
          SPlutusV3 -> [88, 25, 1, 1, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 2, 51, 112, 198, 235, 64, 9, 32, 4, 24, 0, 11, 1]
      )
...
sumsTo103 =
  Plutus
    ...
    . pack
    . ( \case
          SPlutusV1 -> [88, 27, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 20, 51, 112, 6, 235, 64, 8, 221, 104, 1, 136, 144, 0, 139, 1]
          SPlutusV2 -> [88, 27, 1, 0, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 20, 51, 112, 6, 235, 64, 8, 221, 104, 1, 136, 144, 0, 139, 1]
          SPlutusV3 -> [88, 26, 1, 1, 0, 34, 37, 51, 53, 115, 70, 110, 29, 32, 20, 51, 112, 6, 235, 64, 8, 221, 104, 1, 140, 0, 5, 129]
      )
...
oddRedeemer2 =
  Plutus
    ...
    . pack
    . ( \case
          SPlutusV1 -> [88, 25, 1, 0, 0, 34, 83, 51, 87, 52, 102, 225, 210, 0, 35, 55, 12, 110, 180, 0, 146, 0, 65, 18, 0, 17, 97]
          SPlutusV2 -> [88, 25, 1, 0, 0, 34, 83, 51, 87, 52, 102, 225, 210, 0, 35, 55, 12, 110, 180, 0, 146, 0, 65, 18, 0, 17, 97]
          SPlutusV3 -> [88, 24, 1, 1, 0, 34, 83, 51, 87, 52, 102, 225, 210, 0, 35, 55, 12, 110, 180, 0, 146, 0, 65, 128, 0, 177]
      )
