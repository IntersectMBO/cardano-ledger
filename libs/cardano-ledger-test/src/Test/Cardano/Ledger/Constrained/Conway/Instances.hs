...
instance (IsConwayUniv fn, EraPP era) => HasSpec fn (GovAction era)
...
instance (IsConwayUniv fn, Era era, EraPP era) => HasSpec fn (GovActionState era)
...
instance Era era => HasSimpleRep (Proposals era) where
...
instance (EraPP era, IsConwayUniv fn) => HasSpec fn (Proposals era)
...
instance (EraPP era, IsConwayUniv fn) => HasSpec fn (EnactState era)
...
instance (EraPP era, IsConwayUniv fn) => HasSpec fn (PoolEnv era)

instance Era era => HasSimpleRep (CertEnv era)
instance (EraPP era, IsConwayUniv fn) => HasSpec fn (CertEnv era)
...
instance EraPP era => HasSimpleRep (ShelleyTx era) where
...
instance (IsConwayUniv fn, EraPP era, HasSpec fn (Tx era)) => HasSpec fn (CertsEnv era)
