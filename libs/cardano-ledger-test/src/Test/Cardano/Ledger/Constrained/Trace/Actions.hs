...
import Cardano.Ledger.Core (Era (..), EraPParams, TxBody, TxCert)
...
inputsAction :: EraPParams era => Proof era -> Set (TxIn (EraCrypto era)) -> TraceM era ()
...
feesAction :: EraPParams era => Coin -> TraceM era ()
