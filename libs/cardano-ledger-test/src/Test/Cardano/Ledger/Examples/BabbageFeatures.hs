...
toolTests =
  testGroup
    ...
    [ testGroup
        "Alonzo"
        [ testCase "calculate ExUnits" (exampleExUnitCalc @AlonzoEra) -- Move?
        , testCase "attempt calculate ExUnits with invalid tx" (exampleInvalidExUnitCalc @AlonzoEra) -- Move, enhance?
        ]
    , testGroup
        "Babbage"
