...
testUTXOW wit@(UTXOW (Alonzo _)) utxo = testUTXOWwith wit genericCont utxo
testUTXOW wit@(UTXOW (Babbage _)) utxo = testUTXOWwith wit genericCont utxo
testUTXOW (UTXOW other) _ = error ("Cannot use testUTXOW in era " ++ show other)
