...
countEpochStateStats EpochState {..} =
  let markSnap = countSnapShotStat (ssPstakeMark esSnapshots)
      setSnap = countSnapShotStat (ssPstakeSet esSnapshots)
      goSnap = countSnapShotStat (ssPstakeGo esSnapshots)
      stats =
        EpochStateStats
