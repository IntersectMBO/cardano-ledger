{
  ...
  inputs = {
    ...
    iohkNix.url = "github:input-output-hk/iohk-nix/jbgi/fix-crypto-overlay-ordering";
              ...
              tasks = {
                ci = {
                  ...
                  command.text = config.preset.github.status.lib.reportBulk {
                    ...
                    '';
                    each.text = ''nix build --keep-going .#hydraJobs."$1".required || nix build --keep-going -L .#hydraJobs."$1".required'';
