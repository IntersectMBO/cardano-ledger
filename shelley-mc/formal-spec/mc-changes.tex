...
\DeliverableTitle{A Formal Specification of the Cardano Ledger with a Native Multicurrency Implementation}
   {Formal Cardano Ledger with MC Spec.}

\DeliverableResponsible{Formal Methods Team}

\DueDate{31$^{\textrm{st}}$ July 2020}

\SubmissionDate{31$^{\textrm{st}}$ July 2020}{31$^{\textrm{st}}$ July 2020}
...
\newcommand{\ScriptMPS}{\type{Script}_{mps}}
...
\begin{appendix}
  \include{mps-language}
\end{appendix}

\begin{appendix}
  \section*{Appendix B: Outstanding Design Decisions}
  \VerbatimInput{TODO}
\end{appendix}
