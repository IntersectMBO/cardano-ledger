...
\begin{itemize}
  ...
  same as in the Shelley specification.
\end{itemize}
...
\begin{itemize}
  ...
  \item $\fun{checkRedeemers}$ returns $\True$ if the transaction contains an entry
  in the indexed redeemers structure associated with a given $\ScriptPurpose$.
