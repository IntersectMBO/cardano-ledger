...
%      & \text {tag for inputs used to pay script fees}
      ...
      \var{txin}
      & \TxIn
      & \TxId \times \Ix \times \hldiff{\IsFee}
  ...
  \begin{equation*}
    \begin{array}{r@{~~}l@{~~}l@{\qquad}l}
      \var{wits} ~\in~ \TxWitness ~=~
       ...
       & \times ~\hldiff{(\RdmrPtr \mapsto \Data)}& \hldiff{\fun{txrdmrs}}& \text{Indexed redeemers}\\
    \end{array}
  \end{equation*}
  %
  \begin{equation*}
    \begin{array}{r@{~~}l@{~~}l@{\qquad}l}
      ...
      & \times~ \seqof{\DCert} & \fun{txcerts}& \text{Certificates}\\
       ...
       & \times ~\hldiff{\ExUnits}  & \hldiff{\fun{txexunits}}& \text{Script exec. budget}\\
