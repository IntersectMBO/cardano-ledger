...
Recall that collateral inputs are used to cover the transaction fees in the case
that a non-native script fails.
The parameter $\var{collateralPercent}$ is used to specify the percentage of
the total transaction fee its collateral inputs must (at minimum) cover. The
