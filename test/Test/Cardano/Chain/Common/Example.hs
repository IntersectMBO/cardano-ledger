...
import           Cardano.Chain.Common (AddrAttributes (..),
                     ...
                     Address, Attributes, BlockCount (..),
                     ChainDifficulty (..), CoinPortion (..), Script (..),
                     StakeholderId (..), coinPortionDenominator, makeAddress,
                     mkAttributes, mkMultiKeyDistr, mkStakeholderId)
...
import           Test.Cardano.Crypto.Example (examplePublicKey,
                     examplePublicKeys, exampleRedeemPublicKey)
...
exampleStakeholderIds offset l = map (StakeholderId . abstractHash) $ examplePublicKeys offset l
