...
poolTransition = do
  ...
  case poolCert of
    RegPool
      stakePoolParams@StakePoolParams {sppId, sppBlsKey, sppVrf, sppAccountAddress, sppMetadata, sppCost} -> do
        ...
        forM_ sppBlsKey $ \blsKey@BlsKey {blsPubKey, blsPossessionProof} ->
          has
            _Right
