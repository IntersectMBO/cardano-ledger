...
instance
  ...
  encCBOR =
    encode . \case
      ...
      FeeTooSmallUTxO mm -> Sum (FeeTooSmallUTxO . unswapMismatch) 5 !> To (swapMismatch mm)
      ...
      ExUnitsTooBigUTxO mm -> Sum (ExUnitsTooBigUTxO . unswapMismatch) 14 !> To (swapMismatch mm)
      CollateralContainsNonADA a -> Sum CollateralContainsNonADA 15 !> To a
      WrongNetworkInTxBody mm -> Sum (WrongNetworkInTxBody . unswapMismatch) 16 !> To (swapMismatch mm)
      OutsideForecast a -> Sum OutsideForecast 17 !> To a
      TooManyCollateralInputs mm -> Sum (TooManyCollateralInputs . unswapMismatch) 18 !> To (swapMismatch mm)
...
instance
  ...
  decCBOR = decode . Summands "DijkstraUtxoPredFailure" $ \case
    ...
    5 -> SumD FeeTooSmallUTxO <! mapCoder unswapMismatch From
    ...
    14 -> SumD ExUnitsTooBigUTxO <! mapCoder unswapMismatch From
    15 -> SumD CollateralContainsNonADA <! From
    16 -> SumD WrongNetworkInTxBody <! mapCoder unswapMismatch From
    17 -> SumD OutsideForecast <! From
    18 -> SumD TooManyCollateralInputs <! mapCoder unswapMismatch From
