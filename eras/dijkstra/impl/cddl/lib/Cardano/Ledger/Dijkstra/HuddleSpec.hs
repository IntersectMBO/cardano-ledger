...
plutusV4ScriptRule :: forall era. HuddleRule "distinct_bytes" era => Proxy era -> Rule
plutusV4ScriptRule p =
  comment
  ...
  "auxiliary_data_map"
    =:= tag
      ...
      ( mp
          ...
          , opt (idx 1 ==> arr [0 <+ a (dijkstraNativeScriptRule p)])
          ...
          , opt (idx 5 ==> arr [0 <+ a (plutusV4ScriptRule p)])
          ]
      )

instance HuddleRule "min_int64" DijkstraEra where
  huddleRule _ = minInt64Rule

instance HuddleRule "max_int64" DijkstraEra where
  huddleRule _ = maxInt64Rule

instance HuddleRule "int64" DijkstraEra where
  huddleRule = int64Rule @DijkstraEra
...
instance HuddleRule "plutus_data" DijkstraEra where
...
instance HuddleRule "gov_action_id" DijkstraEra where
  huddleRule = govActionIdRule @DijkstraEra
...
instance HuddleRule "plutus_v1_script" DijkstraEra where
  huddleRule = plutusV1ScriptRule

instance HuddleRule "plutus_v2_script" DijkstraEra where
  huddleRule = plutusV2ScriptRule @DijkstraEra

instance HuddleRule "plutus_v3_script" DijkstraEra where
  huddleRule = plutusV3ScriptRule @DijkstraEra

instance HuddleRule "negative_int64" DijkstraEra where
  huddleRule = negativeInt64Rule @DijkstraEra

instance HuddleRule "positive_int64" DijkstraEra where
  huddleRule = positiveInt64Rule @DijkstraEra

instance HuddleRule "nonzero_int64" DijkstraEra where
  huddleRule = nonzeroInt64Rule @DijkstraEra
  ...
  huddleRule p =
    "transaction_witness_set"
      =:= mp
        ...
        , opt $ idx 1 ==> maybeTaggedNonemptySet (dijkstraNativeScriptRule p)
...
instance HuddleRule "plutus_v4_script" DijkstraEra where
  huddleRule = plutusV4ScriptRule @DijkstraEra
