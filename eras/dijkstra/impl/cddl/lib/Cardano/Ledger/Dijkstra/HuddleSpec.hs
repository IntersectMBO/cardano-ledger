...
instance HuddleRule "max_pledge_leverage" DijkstraEra where
  ...
  huddleRuleNamed pname p =
    pname
      =.= mp
        ...
        , opt (idx 49 ==> huddleRule @"slot_interval" p) //- "peras minimum candidate block age in slots"
