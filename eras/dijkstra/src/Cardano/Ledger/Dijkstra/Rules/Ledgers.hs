...
instance InjectRuleFailure "LEDGERS" DijkstraUtxosPredFailure DijkstraEra where
  injectFailure = LedgerFailure . injectFailure
...
instance InjectRuleFailure "LEDGERS" DijkstraCertsPredFailure DijkstraEra where
  injectFailure = LedgerFailure . injectFailure

instance InjectRuleFailure "LEDGERS" DijkstraCertPredFailure DijkstraEra where
  injectFailure = LedgerFailure . injectFailure

instance InjectRuleFailure "LEDGERS" DijkstraDelegPredFailure DijkstraEra where
  injectFailure = LedgerFailure . injectFailure
