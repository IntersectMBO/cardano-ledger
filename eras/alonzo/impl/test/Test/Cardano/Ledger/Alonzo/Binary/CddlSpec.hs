...
spec =
  describe "CDDL" $ do
    ...
    describe "Ruby-based" $ beforeAllCddlFile 3 readAlonzoCddlFiles $ do
      ...
      cddlRoundTripCborSpec @(TxBody AlonzoEra) v "transaction_body"
      ...
      cddlRoundTripCborSpec @(TxOut AlonzoEra) v "alonzo_transaction_output"
    ...
    describe "Huddle" $ specWithHuddle alonzoCDDL 100 $ do
      ...
      huddleRoundTripCborSpec @(TxBody AlonzoEra) v "transaction_body"
      ...
      huddleRoundTripCborSpec @(TxOut AlonzoEra) v "alonzo_transaction_output"
