...
instance
  ...
  decCBOR =
    ...
    where
      ...
      txWitnessField 3 = fieldA addScripts (decodeAlonzoPlutusScript SPlutusV1)
      txWitnessField 4 =
        fieldAA
          (\x wits -> wits {atwrDatsTxWits = x})
          From
      txWitnessField 5 = fieldAA (\x wits -> wits {atwrRdmrsTxWits = x}) From
      txWitnessField 6 = fieldA addScripts (decodeAlonzoPlutusScript SPlutusV2)
      txWitnessField 7 = fieldA addScripts (decodeAlonzoPlutusScript SPlutusV3)
