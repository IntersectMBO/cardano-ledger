...
module Test.Cardano.Ledger.Alonzo.ImpTest (
  ...
  expectPhase2Invalid,
  submitPhase2InvalidTx,
  expectTxSuccess,
  expectTxPhase2Failure,
  -- Fixup
  fixupDatums,
  fixupOutputDatums,
  fixupPPHash,
...
expectPhase2Invalid ::
  ...
  Tx era ->
  ImpTestM era ()
expectPhase2Invalid = void . submitPhase2InvalidTx
