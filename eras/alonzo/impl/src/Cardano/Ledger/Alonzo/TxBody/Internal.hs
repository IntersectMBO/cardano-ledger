...
instance EraTxBody AlonzoEra where
  ...
  mkBasicTxBody = mkMemoized (eraProtVerLow @AlonzoEra) emptyAlonzoTxBodyRaw

  inputsTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrInputs $
      \txBodyRaw inputs_ -> txBodyRaw {atbrInputs = inputs_}
  {-# INLINEABLE inputsTxBodyL #-}

  outputsTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrOutputs $
      \txBodyRaw outputs_ -> txBodyRaw {atbrOutputs = outputs_}
  {-# INLINEABLE outputsTxBodyL #-}

  feeTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrTxFee $
  ...
  certsTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrCerts $
...
instance AlonzoEraTxBody AlonzoEra where
  collateralInputsTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrCollateral $
  ...
  networkIdTxBodyL =
    lensMemoRawType (eraProtVerLow @AlonzoEra) atbrTxNetworkId $
