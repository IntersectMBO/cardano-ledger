  ...
  toJSON pp =
    Aeson.object
      [ "minFeeA" .= appMinfeeA pp,
        ...
        "maxBlockBodySize" .= appMaxBBSize pp,
        "maxTxSize" .= appMaxTxSize pp,
        "maxBlockHeaderSize" .= appMaxBHSize pp,
        ...
        "rho" .= appRho pp,
        "tau" .= appTau pp,
        "decentralisationParam" .= appD pp,
        "extraEntropy" .= appExtraEntropy pp,
        "protocolVersion" .= appProtocolVersion pp,
        "minPoolCost" .= appMinPoolCost pp,
        "lovelacePerUTxOWord" .= appCoinsPerUTxOWord pp,
        "costmdls" .= appCostmdls pp,
        "prices" .= appPrices pp,
        "maxTxExUnits" .= appMaxTxExUnits pp,
        "maxBlockExUnits" .= appMaxBlockExUnits pp,
