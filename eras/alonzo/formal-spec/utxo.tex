...
\item
  ...
  \begin{itemize}
    ...
    the type $\TxIn$, and the index is the index of the list obtained from this ordering.
    \item as with the inputs, the set of policy IDs is ordered lexicographically and the
    index is derived from the list obtained from this ordering.
  \end{itemize}
