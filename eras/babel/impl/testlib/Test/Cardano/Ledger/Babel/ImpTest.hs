...
module Test.Cardano.Ledger.Babel.ImpTest (
...
instance
  ...
  BabelEraImp (BabelEra c)

registerInitialCommittee ::
  (HasCallStack, BabelEraImp era) =>
...
expectNoCurrentProposals :: (HasCallStack, BabelEraImp era) => ImpTestM era ()
