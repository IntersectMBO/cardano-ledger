...
inputsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrSpendInputs $ \txBodyRaw inputs -> txBodyRaw {btbrSpendInputs = inputs}
...
outputsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) (fmap sizedValue . btbrOutputs) $
...
feeBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrTxFee $
...
auxDataHashBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrAuxDataHash $
...
withdrawalsBabbbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrWithdrawals $
...
updateBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrUpdate $
...
certsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrCerts $
...
vldtBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrValidityInterval $
...
mintBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrMint $
...
collateralInputsBabbageTxBodyL ::
  forall era. BabbageEraTxBody era => Lens' (BabbageTxBody era) (Set TxIn)
collateralInputsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrCollateralInputs $
...
reqSignerHashesBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrReqSignerHashes $
...
scriptIntegrityHashBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrScriptIntegrityHash $
...
networkIdBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrTxNetworkId $
...
sizedOutputsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrOutputs $
...
referenceInputsBabbageTxBodyL ::
  forall era. BabbageEraTxBody era => Lens' (BabbageTxBody era) (Set TxIn)
referenceInputsBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrReferenceInputs $
...
totalCollateralBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrTotalCollateral $
...
collateralReturnBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) (fmap sizedValue . btbrCollateralReturn) $
...
sizedCollateralReturnBabbageTxBodyL =
  lensMemoRawType (eraProtVerLow @era) btbrCollateralReturn $
...
instance EraTxBody BabbageEra where
  ...
  mkBasicTxBody = mkMemoized (eraProtVerLow @BabbageEra) basicBabbageTxBodyRaw
