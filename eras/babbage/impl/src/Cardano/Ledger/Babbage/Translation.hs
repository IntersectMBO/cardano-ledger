...
import Cardano.Ledger.Babbage.Genesis (BabbageGenesis (..), extendPPWithGenesis)
import Cardano.Ledger.Babbage.PParams (PParams, PParamsUpdate, extendPP)
...
--------------------------------------------------------------------------------
-- Translation from Mary to Babbage
--
...
type instance PreviousEra (BabbageEra c) = MaryEra c

type instance TranslationContext (BabbageEra c) = BabbageGenesis
...
translatePParams ::
  BabbageGenesis -> Shelley.PParams (MaryEra c) -> PParams (BabbageEra c)
translatePParams = flip extendPPWithGenesis

translatePParamsUpdate ::
  Shelley.PParamsUpdate (MaryEra c) -> PParamsUpdate (BabbageEra c)
