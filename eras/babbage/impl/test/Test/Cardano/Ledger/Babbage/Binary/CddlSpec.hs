...
spec =
  describe "CDDL" $ do
    ...
    describe "Ruby-based" $ beforeAllCddlFile 3 readBabbageCddlFiles $ do
      ...
      cddlRoundTripCborSpec @(TxOut BabbageEra) v "babbage_transaction_output"
    ...
    describe "Huddle" $ specWithHuddle babbageCDDL 100 $ do
      ...
      huddleRoundTripCborSpec @(TxOut BabbageEra) v "babbage_transaction_output"
      ...
      -- huddleRoundTripCborSpec @(PParamsUpdate BabbageEra) v "protocol_param_update" -- FIXME: @aniketd
