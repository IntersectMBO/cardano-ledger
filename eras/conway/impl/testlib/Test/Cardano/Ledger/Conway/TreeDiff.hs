...
instance ToExpr a => ToExpr (PHierarchy a)

instance Era era => ToExpr (PForest PRoot era) where
  toExpr (PForest p h com con) =
    toExpr
      [ toExpr p
      , toExpr h
      , toExpr com
...
instance Era era => ToExpr (PForest PHierarchy era) where
  toExpr (PForest p h com con) =
    toExpr
      [ toExpr p
      , toExpr h
