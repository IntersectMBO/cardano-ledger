...
-- Complete transaction which is compatible with any era starting with Conway.
...
exampleConwayBasedTx ::
  ...
  Tx TopTx era
exampleConwayBasedTx =
  addConwayBasedTxFeatures exampleBabbageBasedTx

-- Complete Conway transaction that is only compatible until Conway era
...
exampleConwayTx ::
  ...
  Tx TopTx era
exampleConwayTx =
  addConwayBasedTxFeatures exampleBabbageToConwayTx
