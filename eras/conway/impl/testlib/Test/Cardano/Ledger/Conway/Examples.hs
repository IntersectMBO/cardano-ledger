...
addConwayBasedTxFeatures tx =
  ...
  where
    redeemers =
      Redeemers $
        Map.fromList
          [ (VotingPurpose $ AsIx 0, (redeemerData, ExUnits 5000 5001))
          , (ProposingPurpose $ AsIx 0, (redeemerData, ExUnits 6000 6001))
          ]
...
exampleConwayCerts =
  StrictSeq.fromList
    ...
    , UnRegDRepTxCert (KeyHashObj (mkKeyHash 9)) (Coin 500001)
