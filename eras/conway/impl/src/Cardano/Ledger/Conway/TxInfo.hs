...
toPlutusV3Args proxy _ txInfo lti plutusPurpose maybeSpendingData redeemerData = do
  scriptPurpose <- toPlutusScriptPurpose proxy (ltiProtVer lti) () plutusPurpose
  let scriptInfo =
        scriptPurposeToScriptInfo
          scriptPurpose
