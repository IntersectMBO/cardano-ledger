...
import qualified Cardano.Ledger.Shelley.HardForks as HardForks (hardforkAllowMIRTransfer)
      ...
      MirTxCert (MIRCert ReservesMIR (StakeAddressesMIR irwd)) ->
        conjoin
          ...
          , counterexample
              ...
              ( if HardForks.hardforkAllowMIRTransfer . view ppProtocolVersionL $ ppDE denv
