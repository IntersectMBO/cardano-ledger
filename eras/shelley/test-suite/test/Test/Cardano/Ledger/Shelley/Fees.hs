...
sizeTest :: HasCallStack => BSL.ByteString -> Tx TopTx ShelleyEra -> Assertion
sizeTest b16 tx = do
...
-- | and has one witness
txbSimpleUTxO :: TxBody TopTx ShelleyEra
txbSimpleUTxO =
  ShelleyTxBody
...
txSimpleUTxO :: Tx TopTx ShelleyEra
txSimpleUTxO =
...
-- | and has two witness
txbMutiUTxO :: TxBody TopTx ShelleyEra
txbMutiUTxO =
  ShelleyTxBody
    { stbInputs =
        Set.fromList
...
txMutiUTxO :: Tx TopTx ShelleyEra
txMutiUTxO =
  MkShelleyTx $
    ShelleyTx
      { stBody = txbMutiUTxO
...
txbRegisterStake :: TxBody TopTx ShelleyEra
txbRegisterStake =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txRegisterStake :: Tx TopTx ShelleyEra
txRegisterStake =
  MkShelleyTx $
    ShelleyTx
...
txbDelegateStake :: TxBody TopTx ShelleyEra
txbDelegateStake =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txDelegateStake :: Tx TopTx ShelleyEra
txDelegateStake =
  MkShelleyTx $
    ShelleyTx
...
txbDeregisterStake :: TxBody TopTx ShelleyEra
txbDeregisterStake =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txDeregisterStake :: Tx TopTx ShelleyEra
txDeregisterStake =
  MkShelleyTx $
    ShelleyTx
...
txbRegisterPool :: TxBody TopTx ShelleyEra
txbRegisterPool =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txRegisterPool :: Tx TopTx ShelleyEra
txRegisterPool =
  MkShelleyTx $
    ShelleyTx
...
txbRetirePool :: TxBody TopTx ShelleyEra
txbRetirePool =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txRetirePool :: Tx TopTx ShelleyEra
txRetirePool =
  MkShelleyTx $
    ShelleyTx
...
txbWithMD :: TxBody TopTx ShelleyEra
txbWithMD =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
...
txbWithMultiSig :: TxBody TopTx ShelleyEra
txbWithMultiSig =
  ShelleyTxBody
...
txWithMultiSig :: Tx TopTx ShelleyEra
txWithMultiSig =
  MkShelleyTx $
    ShelleyTx
...
txbWithWithdrawal :: TxBody TopTx ShelleyEra
txbWithWithdrawal =
  ShelleyTxBody
    { stbInputs = Set.fromList [TxIn genesisId minBound]
    , stbOutputs = StrictSeq.fromList [ShelleyTxOut aliceAddr (Val.inject $ Coin 10)]
    , stbCerts = StrictSeq.empty
    , stbWithdrawals =
        Withdrawals $ Map.singleton (AccountAddress Testnet (AccountId aliceSHK)) (Val.inject $ Coin 100)
    , stbTxFee = Coin 94
    , stbTTL = SlotNo 10
    , stbUpdate = SNothing
    , stbMDHash = SNothing
...
txWithWithdrawal :: Tx TopTx ShelleyEra
txWithWithdrawal =
  MkShelleyTx $
    ShelleyTx
