...
matchingNetworkIDPoolParams =
  (Cast.alicePoolParams @C_Crypto @C_Crypto) {_poolRAcnt = RewardAcnt Testnet Cast.aliceSHK}

-- test globals use Testnet

mismatchingNetworkIDPoolParams :: PoolParams C_Crypto
mismatchingNetworkIDPoolParams =
  (Cast.alicePoolParams @C_Crypto @C_Crypto) {_poolRAcnt = RewardAcnt Mainnet Cast.aliceSHK}
