...
import Cardano.Protocol.TPraos.BlockHeader (BHeader, bhHash, hashHeaderToNonce)
...
txEx10 =
  mkBasicTx txbodyEx10
    & witsTxL
      .~ ( mkBasicTxWits
             & addrTxWitsL
               .~ mkWitnessesVKey
                 (hashAnnotated txbodyEx10)
                 [asWitness Cast.bobPay, asWitness Cast.bobStake]
         )
