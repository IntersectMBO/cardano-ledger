...
\url{https://github.com/intersectmbo/cardano-ledger/tree/master/eras/shelley/impl/cddl/data}.

% TODO - Include the CDDL spec inline?
% \lstinputlisting[backgroundcolor = \color{lightgray}]{../impl/cddl/data/shelley.cddl}
