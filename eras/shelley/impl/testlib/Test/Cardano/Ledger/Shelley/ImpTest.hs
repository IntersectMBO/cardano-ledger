...
class
  ...
  default registerTestAccount ::
    ...
    Accounts era ->
    Accounts era
  registerTestAccount _ Nothing =
    error "When registering Account in Shelley through Babbage Ptr is required"
  registerTestAccount cred (Just ptr) = registerShelleyAccount cred ptr
