\begin{figure}
  \includegraphics[angle=270,trim=0 90 0 90,clip,width=0.7\textwidth]{Workflow1}
...
\begin{figure}
  \includegraphics[angle=270,trim=0 90 0 100,clip,width=0.7\textwidth]{New-Workflow2}
...
(where endorsement indicates the readiness of the stake pool to conform with the new protocol version).
...
in principle be contemporaneous, or even in the reverse order.
