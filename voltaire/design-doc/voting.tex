...
\item
  The total ada that is in circulation (i.e. not accounted in either the treasury or reserves pots).\khcomment{Preferred.}
\item
...
The third option ensures that all ``active'' participants in the blockchain are considered (i.e. the entire voting constituency), but could in theory give results greater than 100\% (because of lag in the
...
While the fourth option may seem attractive, it may result in highly unrepresentative results if insufficient stake holders delegate
