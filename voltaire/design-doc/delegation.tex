...
Ada stakeholders delegate their vote by issuing an on-chain transaction.  As with stake, vote delegation may be transferred, but never retracted.\khcomment{There is an argument that you should  be able to delegate to no-one, but it seems sensible to maintain consistency with the stake delegation mechanism.}
