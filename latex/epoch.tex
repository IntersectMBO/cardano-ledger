...
$\Accnt$, which include $\var{treasury}$, $\var{reserves}$,
and $\var{rewardPool}$. The figure also gives the set of necessary accounting environment
...
\begin{todo}
  Discuss Accounting rule

  What is $\tau$ and $\rho$?

  is $paidRewards$ not used here?
