...
The rewards calculations and related functions are presented in
Figures~\ref{fig:functions:rewards},~\ref{fig:functions:reward-splitting}, and~\ref{fig:functions:reward-calc}.
...
\begin{figure}[htb]
  \begin{align*}
      ...
      & ~~~\Big\{ leader \mapsto \{hk \mapsto d \mid (hk \mapsto leader)\in\var{delegs}\}
                  \Big\vert hk\mapsto d \in distr\Big\}
  \end{align*}
...
\begin{figure}[htb]
  \begin{align*}
      ...
      & ~~~\to \Distr \to \Distr \to (\AddrRWD \mapsto \Coin)\times[0, 1]
      & \text{reward one pool} \\
