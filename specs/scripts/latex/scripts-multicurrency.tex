...
\todo{these scripts probably also need to take some of the data in transaction}
...
~ ~ ~ \text{where} \type{R}
  \text{is an arbitrary type, but must be the same for each validator/redeemer pair.}
\\
