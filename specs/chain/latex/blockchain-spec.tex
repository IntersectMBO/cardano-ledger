...
\begin{figure}[ht]
  \begin{equation*}
    \inference
    {
      \fun{blockSignatureCountWindow} \partialf \var{K} \in pp & \fun{blockSignatureCountThreshold} \partialf \var{t} \in pp \\
...
\begin{figure}[ht]
  \begin{equation*}
    ...
    \\ \maxheadersize \mapsto \var{s_{max}} \in \var{pp} & \bhdrsize{bh} \leq \var{s_{max}}
...
\begin{figure}
  ...
  {
    \neg\isebb{b} &
    \bsize{b} \leq \maxblocksize{b}{\var{pp}} \\
    {\left(
        \begin{array}{l}
          pp \\
          ds
