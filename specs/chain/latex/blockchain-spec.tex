...
\begin{enumerate}
  ...
  \item We check that the header signature correctly verifies the ``signable''
...
UTxO, delegation and update. Each of these have three a signature in the block
