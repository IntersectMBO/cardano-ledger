    ...
    }
    {
      ...
      \trans{upv}{\var{up}}
      {
        \left(
          \begin{array}{l}
            \var{aps \cup \{\var{pid}\}}\\
            \var{vips} \unionoverride \{ \var{nv} \mapsto (\var{pid}, \var{up}) \}
          \end{array}
        \right)
      }
    }
...
\begin{figure}[htb]
  \begin{equation}
    ...
    \inference
    {
      ...
      & \size{\var{vts'} \restrictrange \{\var{pid}\}} < t      
    }
    {
      {
        \begin{array}{l}
  ...
  \begin{equation}
    ...
    \inference
    {
      ...
      \vPropId{v} = \var{pid}
      & \var{pcThr} \mapsto t \in \var{pps}
      & t \leq \size{\var{vts'} \restrictrange \{\var{pid}\}}
    }
    {
      {
        \begin{array}{l}
...
\begin{figure}[htb]
  ...
  \begin{equation}
    ...
    \inference
    {
      ...
      & \neg (\fun{canAdopt}~\var{pps}~\var{bvs'})\\
      \var{bv} \mapsto (\var{pid}, \wcard) \in \var{vips}
      & \var{pid} \in \range~([.., b_n - k] \restrictdom \var{cps})
    }
    {
      {
        \begin{array}{l}
  ...
  \begin{equation}
    ...
    \inference
    {
      ...
      &
      \fun{canAdopt}~\var{pps}~\var{bvs'}\\
      \var{bv} \mapsto (\var{pid}, \var{up}) \in \var{vips}
      & \var{pid} \in \range~([.., b_n - k] \restrictdom \var{cps})\\
    }
    {
      {
      ...
      \trans{upadopt}{\var{bv}}
      {
        \left(
          \begin{array}{l}
            \var{bv}\\
            \upParams{up}\\
            \var{cps} \subtractrange \{ \var{pid} \}\\
            \{ \var{bv} \} \subtractdom \var{vips}\\
            \var{bvs'}
          \end{array}
        \right)
      }
...
\subsubsection{Votes are only positive}
