...
%
Dashed arrows represent the kind of delegation that takes place between
(the owners of) the different keys, whereas the direction of the arrow represent
the source and destination of the delegation information in the certificate:
the owner of a staking key delegates his staking rights to the owner of a stake
pool cold key, using a heavyweight (HW) delegation certificate.
%
The owner of a stake pool hot key delegates his staking rights to a cold key,
via a lightweight (LW) delegation certificate.
%
