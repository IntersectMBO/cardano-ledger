...
guessDecl2args =
  [d|
    guessTheNumber'2 :: P.Data -> P.Data -> ()
...
evenRedeemerDecl =
  [d|
    evenRedeemer' :: P.Data -> P.Data -> P.Data -> ()
...
oddRedeemerDecl =
  [d|
    oddRedeemer' :: P.Data -> P.Data -> P.Data -> ()
