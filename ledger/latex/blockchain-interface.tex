...
$\var{vs_{del}}$ we compute the set of all the versions associated with
proposals id's to be removed, and we remove these versions from $\var{bvs}$.
...
\begin{figure}[htb]
  \begin{equation}
    ...
    \inference
    {
      ...
      & \var{vs_{del}} = \dom~(\var{pids_{old}} \restrictdom \var{rups})
    }
    {
      {
        \begin{array}{l}
      ...
      \trans{upibvreg}{(\var{bv}, \var{vk})}
      {
        \left(
          \begin{array}{l}
            ...
            \var{vs_{del}}  \subtractdom \var{bvs}\\
