...
to an operating system; e.g. `linux`, `win64`, or `mac32`).
...
functions:
\begin{itemize}
\item $\fun{apNameValid}$, which checks that the name is an ASCII string of less
  than 12 characters.
\item $\fun{sTagValid}$, which checks that the name is an ASCII string of less
  than 10 characters.
\end{itemize}
