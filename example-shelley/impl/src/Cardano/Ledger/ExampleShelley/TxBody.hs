...
module Cardano.Ledger.ExampleShelley.TxBody
...
import Cardano.Ledger.ExampleShelley.Timelocks (ValidityInterval (..), ppValidityInterval)
...
-- import Cardano.Ledger.ExampleShelley.TxBody(TxBodyRaw(..))     OR
-- import qualified Cardano.Ledger.ExampleShelley.TxBody as XXX
