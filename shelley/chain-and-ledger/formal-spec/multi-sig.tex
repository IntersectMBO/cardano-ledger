...
In Figure~\ref{fig:types-scripts} the $\Addr$ type of~\cite{shelley_spec}
...
from~\cite{shelley_spec} is extended to carry an additional witness
...
\var{hkeys} being a value of type \type{MultiSig}, partial application of
