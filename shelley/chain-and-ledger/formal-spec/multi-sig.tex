...
multi-signature. This impacts the DELEG transition with its different cases
depending on the kind of delegation certificate as described
in~\cite{shelley_formal_spec}. The second type is spending an element of the
UTxO which required a multi-signature for unlocking. This impacts the UTXOW
transition.
