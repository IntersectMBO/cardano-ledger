...
\SubmissionDate{18th September 2019}{2019/09/18}
...
\hypersetup{
  ...
  \begin{changelog}
	...
	\change{18/09/19}{Kevin Hammond}{FM (IOHK)}{Checked over, fixed problem caused by pdfsync thanks to MG.}
\end{changelog}
