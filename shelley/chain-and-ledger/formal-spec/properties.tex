...
\begin{property}[\textbf{An Epoch Boundary Transition is Never Blocked}]
  \label{prop:epoch-tr-happens}
  \begin{multline*}
    \forall \var{eps}: \applyFun{validLedgerstate}{l},
    l=(\wcard, (u, \wcard)), \exists \var{l'} \in \EpochState: \applyFun{validLedgerstate}{l},
    l' = (\wcard, (u, \wcard))\\
    \implies \forall \var{e} \in \Epoch, lenv \vdash\var{u} \trans{epoch}{e} \var{u'} \\
  \end{multline*}
\end{property}

Property \ref{prop:epoch-tr-happens} states that an epoch boundary transition
is always invoked at the epoch boundary.
