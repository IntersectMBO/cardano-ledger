...
parameter updates, see Section~\ref{sec:pparam-update}. For rules regarding
...
genesis keys agree (see the document~\cite{delegation_design}). Note that this is greater
...
Recall here that $\type{T}^?$ is the option type, see Section~\ref{sec:notation-shelley},
