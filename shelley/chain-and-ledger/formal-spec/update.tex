...
which official Cardano software will automatically follow
\end{itemize}
\end{itemize}
...
in the official Cardano software should
...
\begin{note}
\textbf{Genesis Key Delegations.} The environment for both PP and AV updates contains
...
The state variable $\var{avs}$ stores the official current application version
...
the official AV at slot $s$.
Updating the official AV is part of the rules in the ledger transitionn,
see Section \ref{sec:ledger-trans}.

At most one AV update
...
this update will become the official AV.
