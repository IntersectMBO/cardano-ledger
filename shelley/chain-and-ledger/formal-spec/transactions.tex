...
\begin{itemize}
  ...
  \item $\AVUpdates$, the updates to Shelley software (applications)
\end{itemize}

Note that both are finite maps are indexed by the entities proposing the given
update, the $\VKeyGen$ keys. This is because updates
can only be proposed by the owners of the genesis keys.
