...
updates, $\KeyHashGen$.
We use the abstract type $\KeyHashGen$ to represent the set hashes of genesis
(public verification) keys, which have type $\VKeyGen$. These are a distinct type than the usual
