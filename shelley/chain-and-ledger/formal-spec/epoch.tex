...
\begin{itemize}
  ...
  \item The value $\var{rewardPot}$ is a combination of fees and leftover rewards from
...
\begin{itemize}
  ...
  \item The change to the reward pot. This will be a non-negative value.
...
change in the reward pot presented in Figure~\ref{fig:functions:reward-update-creation}
below is not
  ...
  \begin{equation*}
    ...
    \left(
      \begin{array}{r@{~\in~}ll}
        ...
        \Delta p_t & \Coin & \text{change to the reward pot} \\
...
\begin{itemize}
  ...
  \item Next we calculate change in the $\var{rewardPot}$, the total amount of coin available
  for rewards this
...
The $\fun{applyRUpd}$ function does the following:
    \begin{itemize}
      \item Adjust the treasury, reserves, fee and reward pots by the appropriate amounts.
  ...
  \begin{align*}
      ...
      \left(
        \begin{array}{c}
          ...
          \varUpdate{\var{rewardPot} + \Delta p_t} \\
          ~ \\
          \var{stkeys} \\
