...
\newcommand{\poolReward}[5]{\fun{poolReward}~\var{#1}~\var{#2}~\var{#3}~\var{#4}~\var{#5}}
...
\begin{figure}[htb]
  ...
  \emph{Actual Reward Function, called $\hat{f}_j$ in section 5.5.2 of~\cite{delegation_design}}
  %
  \begin{align*}
      & \fun{poolReward} \in \HashKey \to \unitInterval \to \N \to \N \to \Coin \to \Coin \\
      & \poolReward{hk}{s}{n}{\overline{N}}{\hat{f}} =
      \floor*{\overline{p}\cdot\var{\hat{f}}}\\
      & ~~~\where \\
...
\begin{figure}[htb]
  ...
  \begin{align*}
    & \fun{rewardOnePool} \in \PParams \to \Coin \to \N \to \N \to \HashKey \to \PoolParam\\
      ...
      & \rewardOnePool{pp}{R}{n}{\overline{N}}{poolHK}{pool}{stake}{avgs}{tot}{addrs_{rew}} =
  ...
  \begin{align*}
      ...
      \right\} \\
      & ~~~~~~~\var{results} = \left\{
        hk \mapsto \rewardOnePool{pp}{R}{n}{\overline{N}}{hk}{p}{s}{avgs}{tot}{addrs_{rew}}
                 \mid
