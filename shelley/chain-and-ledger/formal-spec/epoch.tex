...
\begin{itemize}
  ...
  \item The change to the total pot. This will be a non-negative value.
...
Note here that it is not obvious that the calculation of the
change in the total pot presented in Figure~\ref{fig:functions:reward-update-creation}
below is not
negative. A sketch of the proof is provided in
Section 6.4 of~\cite{delegation_design}.
