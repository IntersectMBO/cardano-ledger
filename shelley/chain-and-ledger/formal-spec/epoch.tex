...
\begin{itemize}
  \item First we calculate the change to the reserves,
    as determined by the $\rho$ protocol parameter and the amount that must be
    paid for instantaneous rewards in the map $i_{rwd}$
...
\begin{figure}[htb]
  ...
  \begin{align*}
    ...
    & ~~~~~~~unregistered =
      \left\{
      hk\mapsto val \vert hk\not\in\dom{stDeleg} \wedge \var{hk}\mapsto\var{val}\in \var{i_{rwd}}
      \right\}\\
