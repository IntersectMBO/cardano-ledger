...
\begin{figure}[htb]
  ...
  \begin{equation*}
    \begin{array}{r@{~\in~}lr}
      ...
      \\
      \fun{moveRewards} & \DCertMir \to (\KeyHash \times \Coin)
                                            & \text{moved intermediate rewards}
    \end{array}
  \end{equation*}
  %
...
\begin{figure}
  ...
  \begin{equation*}
    ...
    \left(\begin{array}{r@{~\in~}lr}
            ...
            \var{i_{rwd}} & \KeyHash_{pay} \mapsto (\Slot\times\Coin) & \text{intermediate rewards}\\
          \end{array}
      \right)
      \\
    \\
...
\begin{figure}[hbt]
  ...
  \begin{equation}\label{eq:deleg-mir}
    ...
    {
      \var{c}\in \DCertMir &
      i'_{rew}\leteq\var{\{{hk}\mapsto(\var{slot}, \var{val_{rwd}})\vert
        \var{hk}\mapsto\var{val_{rwd}}\in\fun{moveRewards}~c\}}\\
      slot + 2\cdot\SlotsStabilityParam < \fun{firstSlot}(1 + \fun{epoch}~{slot})
    }
    {
      \begin{array}{r}
        \var{slot} \\
