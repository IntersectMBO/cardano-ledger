...
initialising the moving average of the apparent performance with the median of
the averged apparent performance of the top \(k\) stake pools (i.e., those that
we expect to attract members).
